...
class Raw_data(models.Model):
    ...
    standard_p = models.IntegerField()
    standard_t = models.IntegerField()
    raw_code = models.CharField(max_length=30)
    u = models.IntegerField()
    uu = models.BigIntegerField()
...
#带t*t的系数
class Tt_coefficient(models.Model):
    id = models.AutoField(primary_key=True)
    rom_id = models.CharField(max_length=20)
